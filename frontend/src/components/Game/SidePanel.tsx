    ...
    <aside className="w-52 flex-shrink-0 border-l border-sky-400/10 bg-[rgba(3,15,30,0.5)] backdrop-blur-xl p-5 flex flex-col gap-5 overflow-hidden min-h-screen">
      ...
      {timeLimit > 0 && (
        <div className="flex-shrink-0">
          ...
          <div className="bg-[rgba(3,15,30,0.65)] border border-sky-400/10 rounded-xl p-4 text-center">
            <div
              className={`font-[Cinzel_Decorative] text-3xl tracking-widest leading-none transition-colors duration-300 ${turnSeconds >= timeLimit * 0.75 ? "text-red-300" : "text-sky-300"
                }`}
              style={{
      ...
      <div className="flex-shrink-0">
        ...
        <div className="bg-[rgba(3,15,30,0.65)] border border-sky-400/10 rounded-xl p-4 text-center">
          <div
            className={`font-[Cinzel_Decorative] text-3xl tracking-widest leading-none transition-colors duration-300 ${shotsWarning ? "text-red-300" : "text-sky-300"
              }`}
            style={{
